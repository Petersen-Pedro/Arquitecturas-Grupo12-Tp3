...
public class EstudianteRepositoryImplementacion implements EstudianteRepository {
    ...
    public List<EstudianteDTO> devolverEstudiantes() {
        ...
        try {
            Query query = em.createQuery(/*"SELECT e FROM Estudiante e ORDER BY e.edad DESC"*/"SELECT new TP3.DTO.EstudianteDTO(e.nombres, e.apellido, e.edad, e.genero, e.ciudad_residencia, e.nro_libreta_universitaria) " +
    ...
    public List<EstudianteDTO> devolverEstudiantesPorGenero(String genero) {
        ...
        try {
            Query query = em.createQuery(
                    "SELECT new TP3.DTO.EstudianteDTO(e.nombres, e.apellido, e.edad, e.genero, e.ciudad_residencia, e.nro_libreta_universitaria) " +
                            "FROM Estudiante e " +
