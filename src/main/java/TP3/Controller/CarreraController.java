...
public class CarreraController {
    ...
    @PostMapping("/alta")
    public ResponseEntity<?> crearCarrera(@RequestBody Carreras carrera) {
        try {
    ...
    @PutMapping("/{id}")
    public ResponseEntity<?> actualizarCarrera(@PathVariable int id, @RequestBody Carreras carrera) {
        try {
